...
For all qualifiers, always wrap YottaDB code bracketed by two matching characters (:code:`/` is common) to denote the start and end of the YottaDB code. YottaDB strongly recommends enclosing the code within single quotation marks to prevent inappropriate expansion by the shell. LOOP^%XCMD's command line parser ignores the matching bracketing characters.

Example:

.. code-block:: bash

   /usr/local/lib/yottadb/r138/ydb -run %XCMD 'write "hello world",!'
...
Example which brackets commands by different characters (:code:`*` and :code:`$` in this case):

.. code-block:: bash

   $ ps -ef|yottadb -run LOOP^%XCMD --xec='*if $zpiece(%l,"/",1)?.E1"irq",$increment(match) write %l,!*' --after='$write match," lines",!$'
   root         144       2  0 Oct22 ?        00:00:00 [irq/123-aerdrv]
   root         145       2  0 Oct22 ?        00:00:00 [irq/123-pciehp]
   root         146       2  0 Oct22 ?        00:00:00 [irq/123-pcie-dpc]
   root         147       2  0 Oct22 ?        00:00:00 [irq/124-aerdrv]
   root         148       2  0 Oct22 ?        00:00:00 [irq/124-pciehp]
   root         149       2  0 Oct22 ?        00:00:00 [irq/125-aerdrv]
   root         587       2  0 Oct22 ?        00:00:13 [irq/161-ELAN0412:00]
   root         623       2  0 Oct22 ?        00:00:10 [irq/165-iwlwifi:default_queue]
   root         624       2  0 Oct22 ?        00:00:00 [irq/166-iwlwifi:queue_1]
   root         625       2  0 Oct22 ?        00:00:00 [irq/167-iwlwifi:queue_2]
   root         626       2  0 Oct22 ?        00:00:00 [irq/168-iwlwifi:queue_3]
   root         627       2  0 Oct22 ?        00:00:00 [irq/169-iwlwifi:queue_4]
   root         628       2  0 Oct22 ?        00:00:00 [irq/170-iwlwifi:queue_5]
   root         629       2  0 Oct22 ?        00:00:00 [irq/171-iwlwifi:queue_6]
   root         630       2  0 Oct22 ?        00:00:00 [irq/172-iwlwifi:queue_7]
   root         631       2  0 Oct22 ?        00:00:00 [irq/173-iwlwifi:queue_8]
   root         632       2  0 Oct22 ?        00:00:00 [irq/174-iwlwifi:queue_9]
   root         633       2  0 Oct22 ?        00:00:00 [irq/175-iwlwifi:queue_10]
   root         634       2  0 Oct22 ?        00:00:00 [irq/176-iwlwifi:queue_11]
   root         635       2  0 Oct22 ?        00:00:00 [irq/177-iwlwifi:queue_12]
   root         636       2  0 Oct22 ?        00:00:00 [irq/178-iwlwifi:queue_13]
   root         637       2  0 Oct22 ?        00:00:00 [irq/179-iwlwifi:queue_14]
   root         638       2  0 Oct22 ?        00:00:00 [irq/180-iwlwifi:exception]
   root      156568       2  0 11:03 ?        00:00:00 [irq/163-mei_me]
   root      156569       2  0 11:03 ?        00:00:00 [irq/128-mmc0]
   25 lines
   $
