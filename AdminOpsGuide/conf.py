...
project = u"Administration and Operations Guide"
...
html_context['releases'].append((html_context['curr_rel'], "current/AdminOpsGuide/"))
for tag in tags:
   current_tag = str(tag).replace("d","r")
   html_context['releases'].append((current_tag, current_tag.replace(".","")+"/AdminOpsGuide/"))

# -- Options for HTMLHelp output ------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "Administration and Operations Guide"
