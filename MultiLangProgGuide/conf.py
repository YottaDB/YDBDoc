...
html_context['releases'].append((html_context['curr_rel'], "current/MultiLangProgGuide/"))
for tag in tags:
   current_tag = str(tag).replace("d","r")
   html_context['releases'].append((current_tag, current_tag.replace(".","")+"/MultiLangProgGuide/"))
...
man_pages = [(master_doc, "yottadbdoc", u"Multi Language Programming Guide", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "YottaDBDoc",
        u"Multi Language Programming Guide",
        author,
        "YottaDBDoc",
