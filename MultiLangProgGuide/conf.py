...
project = "MultiLanguage Programmer's Guide"
copyright = "2017-{}, YottaDB LLC".format(datetime.today().year)
author = "YottaDB LLC"
...
latex_documents = [
    (master_doc, "YottaDBDoc.tex", u"Multi Language Programming Guide", u"YottaDB LLC", "manual"),
]
