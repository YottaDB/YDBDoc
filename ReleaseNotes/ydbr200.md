...
Use the following example to confirm that an update corresponding to a Source Server sequence number has reached the Receive Pool. This can be used as a tool to help confirm that there are no in-flight updates.
