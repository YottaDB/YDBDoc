...
html_context['releases'].append((html_context['curr_rel'], "current/Plugins/"))
for tag in tags:
   current_tag = str(tag).replace("d","r")
   html_context['releases'].append((current_tag, current_tag.replace(".","")+"/Plugins/"))
...
latex_documents = [
    (master_doc, "Plugins.tex", "Plugins Documentation", "YottaDB LLC", "manual"),
]
...
texinfo_documents = [
    (master_doc, "Plugins", "Plugins Documentation", author, "Plugins", "One line description of project.", "Miscellaneous"),
]
